...
if ( true )
{
    ...
    (
        ...
        'label'    => sprintf( __( "Add the %sAuthors%s menu to your WordPress dashboard", 'molongui-authorship' ), '<code>', '</code>' ),
    ...
    (
        ...
        'desc'     => '',
        'help'     => sprintf( __( "%sIf enabled, a new item is added to your WordPress menu on the left-hand side of your Dashboard.%s", 'molongui-authorship' ), '<p>', '</p>' ),
        'label'    => sprintf( __( "Add the %sGuest Authors%s menu to your WordPress dashboard", 'molongui-authorship' ), '<code>', '</code>' ),
        'notice'   => __( "Changes will take effect on page refresh", 'molongui-authorship' ),
    );
    $interface   = array();
    $interface[] = array
    ...
    (
        ...
        'desc'     => '',
        'help'     => sprintf( __( "%sIf enabled, a new item is added to your WordPress menu on the left-hand side of your Dashboard.%s", 'molongui-authorship' ), '<p>', '</p>' ),
        'label'    => sprintf( __( "Add the old %sMolongui%s menu to your WordPress dashboard", 'molongui-authorship' ), '<code>', '</code>' ),
        'notice'   => __( "Changes will take effect on page refresh", 'molongui-authorship' ),
    );
    $options[] = array
    (
